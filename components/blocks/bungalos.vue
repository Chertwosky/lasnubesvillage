...
.lightbox__arrow { position: absolute; top: 50%; transform: translateY(-50%); font-size: 60px; color: #fff; background: transparent; border: none; cursor: pointer; z-index: 2; padding: 8px; height: auto; }
.lightbox__arrow.left { left: 0; }
.lightbox__arrow.right { right: 0; }

<template>
    <section class="rebate" id="stocks">
      <div class="rebate__intro">
        <h2
          class="section-badge section-badge--fade rebate__badge"
          style="--badge-bg: linear-gradient(90deg, #1d3557 0%, #0a1b3d 100%); --badge-min-w: 320px;"
        >
          Акции
        </h2>
  ...
  const items = [
    {
      img: Burthday,
      label: '-10%',
      text: 'Скидка 10% в день рождения или годовщину свадьбы',
    },
    {
      img: Feedback,
      label: '-10%',
      text: 'Дарим 10% скидку на следующий заезд за отзыв на Яндекс.Картах',
    },
    {
      img: Bathhouse,
      label: 'Баня',
  ...
  .rebate__intro_title {
    ...
    font-size: calc(var(--fontsize-large) * 1.3);

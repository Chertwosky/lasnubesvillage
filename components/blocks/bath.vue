...
const items = [
  {
    id: 'bath',
    upTitle: 'Русская баня на дровах',
    text: ' — уютная банька с парной на 6 мест. Внутри комната отдыха с чайником, травяным чаем и медом, душевая с обливочным ведром, душем с горячей и холодной водой, большие полотенца, белоснежные халаты, гигиенические наборы, банные шапки и одноразовые тапочки. На террасе — шезлонги для отдыха после парения. Стоимость 2000 ₽/час, бронирование от 2 часов, в продаже запарки и веники с перемотанной ручкой от 350 ₽ (канадский и кавказский дуб, пихта, эвкалипт, ольха/липа).',
    location: 'Рядом с коттеджем, терраса с шезлонгами',
    beds: 'Минимум 2 часа, 2000 ₽/час',
    guests: 'Парная на 6 мест, веники от 350 ₽',

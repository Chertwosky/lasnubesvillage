<template>
    <section class="villages">
      <div class="villages__intro">
        <h2
          class="section-badge section-badge--fade section-badge--right villages__badge"
          style="--badge-bg: linear-gradient(90deg, #0e0b27 0%, #0a0820 100%); --badge-pad-right: 120px;"
        >
          A-frame
        </h2>
